...
ENV PYENV_ROOT=${DJANGO_ROOT}/.pyenv
ENV PATH=${PYENV_ROOT}/shims:${PYENV_ROOT}/bin:${PATH}
ENV DJANGO_USER=${DJANGO_USER} DJANGO_LOGDIR=${APP_ROOT}/logs/${APP_NAME} ENV_TYPE=${ENV_TYPE}
...
ENV REDIS_URL=${REDIS_URL} MEMCACHE_URL=${MEMCACHE_URL} DATABASE_URL=${DATABASE_URL} EMAIL_URL=${EMAIL_URL}
