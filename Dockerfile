...
ENV S3_DOMAIN=${S3_DOMAIN} S3_REGION=${S3_REGION} S3_ACCESS_KEY=${S3_ACCESS_KEY} S3_SECRET_KEY=${S3_SECRET_KEY} S3_BUCKET_NAME=${S3_BUCKET_NAME}
ENV STRIPE_PUBLIC_KEY=${STRIPE_PUBLIC_KEY} STRIPE_PRIVATE_KEY=${STRIPE_PRIVATE_KEY} STRIPE_SIGNING_KEY=${STRIPE_SIGNING_KEY}
